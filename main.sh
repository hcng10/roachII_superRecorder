#!/bin/bash
remRunDir="~/Desktop/hcng_2000Sam_CellsI_m99" # This is the remote directory on 4 machines
runDir="/media/varma/ganymede1/scripts/hcng_2000Sam_CellsI_m99" # The folder machine from where you run this script
comp1="147.8.183.178" 
comp2="147.8.183.236"
comp3="147.8.182.235"
comp4="147.8.183.120"
...
#########
ssh $comp1 'sudo /home/varma/Desktop/maxeler_gulp/free_mem.sh' &
ssh $comp2 'sudo /home/varma/Desktop/maxeler_gulp/free_mem.sh' &
ssh $comp3 'sudo /home/varma/Desktop/maxeler_gulp/free_mem.sh' &
ssh $comp4 'sudo /home/varma/Desktop/maxeler_gulp/free_mem.sh' &
wait

ssh $casr2 'cd boffiles/varma && python dumy.py' ##dummy files to stop sending data over ethernet. This makes it simpler to synchronise eth data
...
#ssh $casr2 'cd boffiles/varma/adc_tests-disentangle &&  python varma2_fullethdev4.py -r 192.168.100.182 -b adcethvfullv64_2015_Sep_16_1915.bof'
ssh $casr2 'cd boffiles/hcng_nov_m2/jack_disentangle/adc_tests &&  python varma2_fullethdev4.py -r 192.168.100.182 -b adcethvfullv64_2015_Dec_01_0023.bof'
 #adcethvfullv64_2015_Sep_09_0946.bof'
## python varma2_fullethdev3.py -r roach2  -b adcethvfullv4_2015_Apr_14_1418.bof'

echo "Waiting for 1.pcap to finish on each of the systems"
wait
ssh $casr2 'cd boffiles/varma && python dumy.py' ##dummy files to stop sending data over ethernet.
...
#for i in {1..130147..1024}
#for i in {1..4096..1024}
 # do
  #   val=`expr $i + 1023`
   #  echo "$i $val"
    #  sed -n $i,$val"p" op1 >>data1.txt;
     # sed -n $i,$val"p" op2 >>data1.txt;
 #    # sed -n $i,$val"p" op3 >>data2.txt;
  #    sed -n $i,$val"p" op4 >>data2.txt;
    #  echo $"i",$"val"p 
#done
##########################################
./writedata1 >plot1
