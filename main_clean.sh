#!/bin/bash
remCleanDir="~/Desktop/hcng_2000Sam_CellsI_m99" # This is the remote directory on 4 machines
cleanDir="/media/varma/ganymede1/scripts/hcng_2000Sam_CellsI_m99" # The folder machine from where you run this script
